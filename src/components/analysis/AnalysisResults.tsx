        ...
        <div className="space-y-8 animate-up">
            ...
            <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                    <div className={cn(
                        "p-2 rounded-lg",
                        currentAnalysis.severity === 'critical' ? "bg-red-500/10 text-red-500" :
                            currentAnalysis.severity === 'warning' ? "bg-amber-500/10 text-amber-500" :
                                "bg-blue-500/10 text-blue-500"
                    )}>
                        <AlertTriangle className="w-6 h-6" />
                    </div>
                    <div>
                        <h2 className="text-4xl font-bold text-white tracking-tight">{currentAnalysis.errorType}</h2>
                        <p className="text-xl text-muted-foreground mt-1">{currentAnalysis.rootCause}</p>
                    </div>
                </div>
                <CopyErrorButton
            ...
            {currentAnalysis.filesLikelyAffected.length > 0 && (
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 overflow-hidden">
                    ...
                    <div className="p-4 font-mono text-sm text-gray-300 bg-[#0f0f0f]">
                        <div className="flex gap-4">
                            <div className="flex flex-col text-right text-muted-foreground/30 select-none">
                                <span>45</span>
                                <span>46</span>
                                <span className="text-red-500 font-bold">47</span>
                                <span>48</span>
                                <span>49</span>
                            </div>
                    ...
                    <div className="px-4 py-2 bg-red-500/5 border-t border-red-500/10 text-right">
                        <button className="text-xs font-medium text-red-400 hover:text-red-300 transition-colors flex items-center justify-end gap-1 ml-auto">
